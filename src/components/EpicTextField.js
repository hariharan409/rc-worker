                ...
                render={({ field: { onChange, onBlur, value } }) => (
                    <View style={{ marginTop: 20 }}>
                        ...
                        <TextInput 
                            ...
                            style={{ width: "100%", height: 30, marginTop: 8, borderColor: "rgba(0,0,0,0.2)", borderWidth: 2, borderRadius: 5, paddingHorizontal: 10, fontSize: 16,textTransform: "capitalize" }} 
