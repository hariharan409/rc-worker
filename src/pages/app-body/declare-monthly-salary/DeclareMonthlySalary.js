...
const DeclareMonthlySalary = () => {
    const {control,errors,handleSubmit,onFormSubmit} = useDeclareMonthlySalary();
    ...
    return(
        <ScrollView contentContainerStyle={styles.declarationContainer}>
            <View style={styles.declarationCard}>
                ...
                <EpicDatePicker name="salaryCreditedOn" control={control} label="salary credited on" error={errors.salaryCreditedOn} />
